        ...
        <div class="container-fluid">
            ...
            <div class="panel panel-headline">
                <div class="panel-heading">
                    <h3 class="panel-title">Role <small><i class="fa fa-arrow-circle-left"></i><a href="{{route('allRoles')}}">To List</a></small></h3>
                </div>
                <div class="panel-body">
                    ...
                    <div class="row">
                            ...
                            <form class="form-horizontal" action="{{route('postRole')}}" method="post" enctype="multipart/form-data">
                              <div class="form-group">
                                <label for="role_name" class="control-label col-sm-2">Name</label>
                                <div class="col-sm-10">
                                  <input type="text" class="form-control" id="role_name" name="role_name" placeholder="* Name">
